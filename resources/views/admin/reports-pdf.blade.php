...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Page ──
           IMPORTANT: DomPDF uses its own font resolver.
           Always use generic families (sans-serif / serif / monospace)
           so DomPDF maps them to its bundled fonts correctly.
        ── */
        body {
...
<body>
    ...
    <div class="report-header">
        <div class="report-header-left">
            ...
            <div class="report-subtitle">Appointment Report &mdash; {{ $dateLabel }}</div>
