...
<main class="main">
    ...
    {{-- Hidden filter form — uses ADMIN route --}}
    <form method="GET" action="{{ route('reports.index') }}" id="filter-form" style="display:none;">
    ...
    <div class="reports-body">
        ...
        <div class="summary-strip">
            ...
            <div class="export-group">
                <a href="{{ route('reports.pdf', array_filter(['date_filter' => $dateFilter, 'custom_date' => $customDate ?? ''])) }}"
                ...
                <a href="{{ route('reports.csv', array_filter(['date_filter' => $dateFilter, 'custom_date' => $customDate ?? ''])) }}"
...
<script>
    ...
    /* SVG icons per status (inline, 9×9 viewport) */
    var STATUS_ICONS = {
    ...
    function submitDelete() {
        ...
        form.action = '/reports/' + pendingDeleteId;
        form.submit();
    }
