{{-- resources/views/receptionist/reports.blade.php --}}
<!DOCTYPE html>
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tl-status {
            font-size: 12px; font-weight: 800; color: #222; line-height: 1.2;
        }
        .tl-meta {
...
<main class="main">
    ...
    {{-- Hidden filter form --}}
    <form method="GET" action="{{ route('receptionist.reports.index') }}" id="filter-form" style="display:none;">
    ...
    <div class="reports-body">
        ...
        <div class="summary-strip">
            ...
            <div class="export-group">
                <a href="{{ route('receptionist.reports.pdf', array_filter(['date_filter' => $dateFilter, 'custom_date' => $customDate ?? ''])) }}"
                ...
                <a href="{{ route('receptionist.reports.csv', array_filter(['date_filter' => $dateFilter, 'custom_date' => $customDate ?? ''])) }}"
...
<script>
    ...
    function submitDelete() {
        ...
        form.action = '/receptionist/reports/' + pendingDeleteId;
        form.submit();
    }
    ...
    function renderControls() {
        ...
        info.textContent = 'Showing ' + start + '–' + end + ' of ' + totalRows + ' record' + (totalRows !== 1 ? 's' : '');
