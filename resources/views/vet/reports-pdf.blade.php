{{-- resources/views/vet/reports-pdf.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .summary-strip {
            ...
            margin-bottom: 12px;
            background: #f4fdf6; border: 1px solid #b2dfbf;
        }
        .summary-cell {
            display: table-cell; padding: 7px 14px;
            vertical-align: middle; border-right: 1px solid #c8e6c9;
        }
        ...
        table.report-table { width: 100%; border-collapse: collapse; border: 1px solid #ddd; }
        ...
        .empty-row td { text-align: center; padding: 28px 0; font-size: 10px; color: #aaa; }
...
<body>
    ...
    <div class="report-header">
        <div class="report-header-left">
            ...
            <div class="report-role-tag">Veterinarian Report</div>
        </div>
